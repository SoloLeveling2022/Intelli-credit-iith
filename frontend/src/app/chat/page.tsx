...
export default function ChatPage() {
  ...
  return (
    <PageShell
      title="AI Assistant"
      description="Context-aware credit analysis and compliance assistant powered by your Knowledge Graph"
    >
      <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 max-w-xl w-full">
                  {suggestions.map((s, i) => {
                    ...
                    return (
                      ...
                      >
                        <Icon className="w-4 h-4 c-text-3 group-hover:c-text-accent shrink-0 mt-0.5" />
                        <span>{s}</span>
                      </button>
                    );
                  })}
            ...
            <>
              {messages.map((msg) => (
                ...
                >
                  ...
                  {msg.role === "user" && (
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-1 c-bg-dark">
