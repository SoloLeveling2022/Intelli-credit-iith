...
export default function FloatingChat() {
  ...
  const hidden = pathname === "/" || pathname === "/login" || pathname === "/register" || pathname === "/chat";
  ...
  return (
    <>
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full gap-4">
                <div className="text-center">
                  ...
                  <p className="text-xs c-text-3 max-w-70">
              ...
              <>
                {messages.map((msg) => (
                  ...
                  >
                    ...
                    {msg.role === "user" && (
                      <div className="w-6 h-6 rounded-md flex items-center justify-center shrink-0 mt-0.5 c-bg-dark">
      ...
      <button
        ...
        title="Chat with Credit Assistant"
      >
        {isOpen ? (
          <X className="w-6 h-6" />
        ) : (
