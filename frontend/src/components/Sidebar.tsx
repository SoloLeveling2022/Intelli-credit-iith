...
const navItems = [
  ...
  { href: "/primary-insights", label: "Primary Insights", icon: Phone },
  { href: "/upload", label: "Upload Documents", icon: Upload },
  { href: "/reconcile", label: "Credit Appraisal", icon: GitCompare },
  { href: "/research", label: "Company Research", icon: Search },
  { href: "/due-diligence", label: "Due Diligence", icon: CheckSquare },
  { href: "/graph", label: "Graph Explorer", icon: Network },
  { href: "/audit", label: "CAM Reports", icon: FileSearch },
  { href: "/risk", label: "Credit Risk", icon: ShieldAlert },
