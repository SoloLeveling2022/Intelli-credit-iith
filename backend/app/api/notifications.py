...
async def test_notification():
    ...
    test_message = "Intelli-Credit Alert: This is a test notification from the Credit Appraisal & GST Compliance Platform."
    ...
    if channel == "email":
        ...
        try:
            _send_email(email_to, "Intelli-Credit - Test Notification", test_message)
...
def _send_email(to: str, subject: str, body: str):
    msg = MIMEText(body)
    msg["Subject"] = subject
    msg["From"] = "noreply@intellicredit.com"
    msg["To"] = to
